  ...
  <v-container class="section-container py-16" fluid>
    <v-container>
      <div class="text-center mb-12">
        <p class="section-kicker mb-3">Selected Work</p>
        <h2 class="section-title font-weight-black mb-4">Portfolio</h2>
        <p class="section-subtitle">
          A focused look at mobile and web products I helped design, build, and ship.
        </p>
      </div>
      ...
      <v-row>
        ...
        <v-col
          ...
          md="4"
        >
          <v-card class="more-projects-card pa-0" elevation="0">
...
const projects = [
  {
    ...
    technologies: ['React Native', 'Nest.js', 'MongoDB', 'IA','Neo4j','WebSocket'],
    demo: '',
    github: '',
  },
  {
 ...
 
  {
    ...
    technologies: ['React Native', 'Nest.js','MongoDb', 'WebSocket','Stripe','Paypal'],
    demo: '',
    github: '',
  },
  {
    ...
    image: jva05,
    images: [ jva05],
    technologies: ['Vue.js', 'vuetify.js', 'Nest.js', 'IA','Python','Robocorp'],
    demo: '',
    github: '',
  },
]
...
.portfolio-card {
  ...
  background: linear-gradient(145deg, rgba(17, 24, 39, 0.9), rgba(15, 23, 42, 0.68));
...
.portfolio-overlay {
  ...
  right: 0;
  bottom: 0;
  background: linear-gradient(135deg, rgba(20, 184, 166, 0.72), rgba(7, 10, 18, 0.72));
  display: flex;
  align-items: center;
...
.more-projects-card {
  ...
  justify-content: center;
  border-radius: 24px;
  background: linear-gradient(135deg, rgba(20, 184, 166, 0.08) 0%, rgba(249, 115, 22, 0.08) 100%);
...
.more-projects-card:hover {
  background: linear-gradient(135deg, rgba(20, 184, 166, 0.14) 0%, rgba(249, 115, 22, 0.14) 100%);
  border-color: rgba(94, 234, 212, 0.55);
  transform: translateY(-5px);
  box-shadow: 0 18px 60px rgba(20, 184, 166, 0.14);
}
