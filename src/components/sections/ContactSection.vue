  ...
  <v-container class="section-container py-16" fluid>
    <v-container>
      <div class="text-center mb-12">
        ...
        <h2 class="section-title font-weight-black mb-4">Get In Touch</h2>
        <p class="section-subtitle">
          I'm open to discussing new products, creative ideas, freelance work, or full-time opportunities.
        </p>
      </div>
      ...
      <v-row>
        <v-col cols="12" md="4">
          <v-card
            ...
            :key="contact.type"
            class="contact-card glass-panel mb-4 pa-6"
            elevation="0"
          >
        ...
        <v-col cols="12" md="8">
          <v-card class="contact-form-card glass-panel pa-6" elevation="0">
