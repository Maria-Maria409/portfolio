  ...
  <v-container class="section-container py-16" fluid>
    <v-container>
      <div class="text-center mb-12">
        <p class="section-kicker mb-3">Stack</p>
        <h2 class="section-title font-weight-black mb-4">Skills & Expertise</h2>
        <p class="section-subtitle">
          The tools I use to design, ship, automate, and maintain digital products.
        </p>
      </div>
      ...
      <v-row>
        <v-col
          ...
          class="mb-8"
        >
          <v-card class="skill-category-card glass-panel pa-6" elevation="0">
            ...
            <v-row dense class="skill-grid">
              <v-col
                ...
                sm="6"
              >
                <v-card class="skill-tile pa-4" variant="tonal">
                  <div class="d-flex align-center">
                    <v-avatar size="48" rounded class="mr-4 skill-avatar">
                      <v-img
                        :src="skill.logo"
                        :alt="skill.name"
                        cover
