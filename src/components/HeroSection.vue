...
.hero-cover {
  ...
  flex: 1;
  border-radius: 32px;
  box-shadow: 0 24px 48px rgba(26, 3, 56, 0.4);
  overflow: hidden;
  height: 70vh;
  min-height: 500px;
}

/* Background container for Vanta Halo */
...
/* Ensure the Vanta element fills the container */
#el {
  width: 100%;
  height: 100%;
...
/* Custom breakpoint for width around 887px */
